	...
	const bool& isShow, const bool& isSave)
{
	...
	sample::gLogInfo << 
		"copy time = " << t0 / param.batch_size << "ms; "
...
int main(int argc, char** argv)
{
	...
	setParameters(param);
	// path
	std::string model_path = "D:\\Download\\TensorRT-8.6.1.6.Windows10.x86_64.cuda-12.0\\TensorRT-8.6.1.6\\bin\\yolov8s.trt";
	std::string video_path = "";
	std::string image_path = "E:\\ultralytics\\bus.jpg";
	// camera' id
	int camera_id = 0;
